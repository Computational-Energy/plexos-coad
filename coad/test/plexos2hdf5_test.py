...
import os
import unittest
from plexos2hdf5 import plexos2hdf5, get_child_datasets, get_dataframe
...
class TestPlexosSolution(unittest.TestCase):
    ...
    def test_process(self):
        ...
        h5filename = "test/mda_output_process.hdf5"
        h5file = plexos2hdf5("test/mda_output.zip", h5filename)
        # Was data loaded
    ...
    def test_object_values(self):
        ...
        """
        h5filename = "test/mda_output_values.hdf5"
        h5file = plexos2hdf5("test/mda_output.zip", h5filename)
    ...
    def test_object_times(self):
        ...
        """
        h5filename = "test/mda_output_times.hdf5"
        h5file = plexos2hdf5("test/mda_output.zip", h5filename)
